...
import Tour from '../components/tour/itinerareo/TourYellow';
...
const tour = () => {
	return (
		<div className="container-fluid p-0">
			<Layout>
				<Seo />
				<HeaderTour titulo={'Yellow Faced Parrotlet-Purple Backed Sunbean'}>
					<StaticImage className="tourpage-image" src={'../images/tour_yellow.jpg'} alt="Yellow" placeholder="none" />
				</HeaderTour>
				<main>
					<Guide />
					<Tour />
