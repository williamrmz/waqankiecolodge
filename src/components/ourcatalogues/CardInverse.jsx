...
const Card = ({ image, title, description, ruta }) => {
	...
	return (
		<div className="card h-100 catalogue-card text-center ">
			...
			<div className="image-link-to h-50 d-flex justify-content-center text-center">
				{image}
				<div className="btn-more-info-inverse" data-sal="slide-up" data-sal-duration="600" data-sal-easing="ease">
